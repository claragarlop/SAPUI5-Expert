		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices List",
									"targetURL": "#claragarlopinvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"claragarlopinvoices-display": {
								"semanticObject": "claragarlopinvoices",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=claragarlop.invoices",
									"url": sap.ui.require.toUrl("claragarlop/invoices")
								}
							}
						}
					}
