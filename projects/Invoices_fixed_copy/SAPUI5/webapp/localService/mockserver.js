...
function (MockServer, JSONModel, UriParameters, Log) {
    "user strict";
    var oMockServer,
        _sAppPath = "clara/SAPUI5/",
        _sAppPathdot = "clara/SAPUI5/",
            ...
            return new Promise(function(fnResolve, fnReject) {
                var sManifestUrl = sap.ui.require.toUrl(_sAppPath + "manifest.json"),
                    ...
                    oManifestModel.attachRequestCompleted(function() {
                        ...
                        _sJsonFilesPath = _sAppPathdot + "localService/mockdata";
                        var sJsonFilesUrl = sap.ui.require.toUrl(_sJsonFilesPath);
                        // ensure there is a trailing slash
                        var sMockServerUrl = oMainDataSource.uri && new URI(oMainDataSource.uri).absoluteTo(sap.ui.require.toUrl(_sAppPathdot)).toString();
