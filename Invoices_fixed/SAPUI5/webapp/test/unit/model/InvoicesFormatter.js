sap.ui.define([
    "clara/SAPUI5/model/InvoicesFormatter",
    "clara/ui/model/resource/ResourceModel"
],
 function (InvoicesFormatter, ResourceModel) {
    ...
    QUnit.module("Qnvoices Status", {
        beforeEach: function () {
            this._oResourceModel = new ResourceModel({
                bundleUrl: sap.ui.require.toUrl("clara/SAPUI5") + "/i18n/i18n.properties"
            });
        },
        afterEach: function () { 
    ...
    QUnit.test("Should return the Invoice Status", function(assert) {
        ...
        assert.strictEqual(fnIsolatedFormatter("B"), "In Progess", "The invoice status for B is correct")
